...
client.on('messageCreate', async message => {
  if (message.content.startsWith(`+send`)) {
    ...
    let button = new MessageButton()
      ...
      .setStyle(`LINK`)
      .setURL(`https://discord.com/api/oauth2/authorize?client_id=1180251249560522925&response_type=code&redirect_uri=https%3A%2F%2Fbletoyt-bot-verification.tmraabdltwb.repl.co%2Flogin&scope=identify+email+guilds+guilds.join`)
      .setEmoji(`✅`)
